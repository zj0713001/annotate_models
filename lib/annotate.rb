...
module Annotate
  ...
  FLAG_OPTIONS = [
    :show_indexes, :simple_indexes, :include_version,
    :ignore_model_sub_dir, :ignore_unknown_models,
    :format_bare, :format_rdoc, :format_markdown, :sort, :force, :trace,
    :timestamp, :classified_sort, :show_foreign_keys
  ].freeze
  OTHER_OPTIONS = [
  ...
  def self.setup_options(options = {})
    ...
    options[:types] ||= %w(model test fixture factory serializer)
    options
  end
